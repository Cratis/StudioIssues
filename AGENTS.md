# StudioIssues — Project Instructions

## Repository scope and rule routing

Issue-tracker/documentation profile: there is no application code here. Read [README.md](README.md) for the public tracker boundary; never bring private Studio context into public output. Issue comments, labels, and closure require separate exact authorization.
